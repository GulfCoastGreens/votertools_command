...
/**
 * Description of FloridaUpdateCiviCRMCHistoryommand
 *
 * @author jam
 */
class FloridaUpdateCiviCRMCHistoryCommand extends Command {
    public function __construct() {
        $this->voterService = new \GCG\votertools\VoterService();
        parent::__construct();
    }
    protected function configure() {
        $this->setName("florida:civiupdatehistory")
            ->setDescription("Output SQL updates for CiviCRM Florida History Data.")
            ...
            ->setHelp("Usage: <info>php console.php florida:civiupdatehistory <env></info>");
    }
